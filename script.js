...
// Open Instagram with pre-filled message (NEW FLOW)
function proceedToInstagram() {
    ...
    // Show Instagram instructions with confirmation button
    showInstagramInstructionsWithButton();
}
...
// Show Instagram instructions with confirmation button (NEW FLOW)
function showInstagramInstructionsWithButton() {
    ...
    instruction.innerHTML = `
        <div class="instagram-instruction-content">
            ...
            <div class="instruction-text">
                <h4>📋 Pasos para hacer tu pedido:</h4>
                <div class="steps-container">
                    <div class="step">
                        <span class="step-number">1</span>
                        <span class="step-text">El mensaje se copió automáticamente</span>
                    </div>
                    <div class="step">
                        <span class="step-number">2</span>
                        <span class="step-text">Se abrirá tu perfil de Instagram</span>
                    </div>
                    <div class="step">
                        <span class="step-number">3</span>
                        <span class="step-text">Ve a "Mensajes" (DM)</span>
                    </div>
                    <div class="step">
                        <span class="step-number">4</span>
                        <span class="step-text">Busca "@origin_tfto"</span>
                    </div>
                    <div class="step">
                        <span class="step-number">5</span>
                        <span class="step-text">Pega y envía el mensaje</span>
                    </div>
                </div>
                <p class="ready-text">¡Todo listo! Tu mensaje ya está copiado.</p>
            </div>
            <div class="instruction-buttons">
                <button class="cancel-btn" onclick="closeInstagramInstructions()">Cancelar</button>
                <button class="continue-btn" onclick="openInstagramAndComplete()">Continuar a Instagram 📸</button>
            </div>
        </div>
    `;
...
// Close Instagram instructions
function closeInstagramInstructions() {
    const instruction = document.querySelector('.instagram-instruction');
    if (instruction) {
...
// Open Instagram and complete the process
function openInstagramAndComplete() {
    // Close instructions
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
            showFinalInstagramInstructions();
        }, 1000);
    }, 500);
}

// Show final instructions after Instagram is opened
function showFinalInstagramInstructions() {
    const instruction = document.createElement('div');
    instruction.className = 'instagram-instruction final';
    instruction.innerHTML = `
        <div class="instagram-instruction-content">
            <span class="instruction-icon">✅</span>
            <div class="instruction-text">
...
function showInstagramInstructions() {
    // This function is kept for any existing calls
    setTimeout(() => {
        showFinalInstagramInstructions();
    }, 100);
}
